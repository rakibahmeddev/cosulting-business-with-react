  ...
  return (
    <div className="bg-white py-20">
      <div class="m mx-auto px-20">
        ...
        <ul class="flex items-start gap-8 flex-wrap w-full  mx-auto">
          <li class="w-2/5 bg-slate-50 px-5 py-5 rounded-lg shadow-lg my-5">
            ...
            <p class="mt-2">
              ...
              <p class="text-base leading-6 text-gray-500 mb-3">
                ...
                access a resource. A good example is house ownership. The owner
                has full access rights to the property (the resource) but can
                grant other people the right to access it. You say that the
                owner authorizes people to access it. This simple example allows
                us to introduce a few concepts in the authorization context.
              </p>
            </p>
          </li>
          <li class="w-2/5 bg-slate-50 px-5 py-5 rounded-lg shadow-lg my-5">
